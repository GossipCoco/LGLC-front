<template>
  <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-xs-12 card-global">
    <div class="card background-lineart02 border-none fiction-card all-fictions-card">
      ...
      <div class="card-body padding-2-vh display-flex-column">        
          <div
            class="display-flex-row width-100-100 padding-2-vh"

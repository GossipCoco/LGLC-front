...
export default {
  ...
  data() {
    return {
      ...
      isMenuOpen: false,
      showSubMenu: false,
      logo: "/images/Logos/new-logo-lgdc.png",
      menuClass:'menu-left background-lineart-menu d-flex display-flex-row flex-shrink-0 height-15-vh margin--0-0--2 scrollbar-color',

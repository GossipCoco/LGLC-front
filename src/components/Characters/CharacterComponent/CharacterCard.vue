<template> 
  <div  id="all-characters-container-card" class="row all-characters-container-card width-10-rem">
    <div class="col-12 mb-3 mb-sm-0 display-flex-row align-items-content-justify-content character-container overflowY-X-hidden">
      <div
        ...
        :key="index"
        class="character-card height-20-rem border-none text-white background-color-dark-green-01 background-size-cover card flex-one opensans-text"
      >

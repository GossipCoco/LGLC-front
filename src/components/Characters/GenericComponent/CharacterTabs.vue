  ...
  <div class="tab-content height-50-vh" id="pills-tabContent">
    ...
    >
      ...
      <TextAreaOriginalCharacter
        ...
        v-bind:getDatas="'getDescription'"
        @getDescription="getDescription"
      >
        <button
          type="button"
          class="btn btn-primary"
          v-on:click="editAndSendDescription"
        >
    ...
    >
      ...
      <TextAreaOriginalCharacter
        v-if="EditPersonnalityTextArea"
        v-bind:Title="'Personnalité'"
        v-bind:Text="Personnality"
        v-bind:getDatas="'getPersonnality'"
        @getPersonnality="getPersonnality"
      >
        <button
          type="button"
          class="btn btn-primary"
          v-on:click="editAndSendPersonnality"
        >
          Editer la personnalité
        </button>
        <button type="button" class="btn btn-primary" v-on:click="cancel">
          Annuler
        </button>
    ...
    >
      ...
      <TextAreaOriginalCharacter
        v-if="EditBiographyTextArea"
        v-bind:Title="'Biographie'"
        v-bind:Text="Biography"
        v-bind:getDatas="'getBiography'"
        @getBiography="getBiography"
      >
        <button
          type="button"
          class="btn btn-primary"
          v-on:click="editAndSendBiography"
        >
...
import TableInformationCharacter from "./TableInformationCharacter.vue";
import BackClan from "./BackClan.vue";
export default {
  name: "CharacterTabs",
  props: [
    "ClanId",

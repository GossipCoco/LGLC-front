<template>
  <div class="fiction-globale-container height-90 background-lineart margin-0-0-4-0 card display-flex-column padding-0 overflowY-hidden overflowX-hidden text-white flex-one opensans-text">
    ...
    <Spinner v-if="showspinner" />
    <div class="card-body margin-0-0-15vh-0 width-100-100 height-100-vh padding-1-0-0-1vh overflowY-scroll overflowX-hidden" v-if="!showspinner">
      <div class="row">
        <div class="col-12">

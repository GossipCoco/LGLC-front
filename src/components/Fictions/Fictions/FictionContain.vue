    ...
    <div class="fiction-globale-container card fiction-container">
        ...
        <div class="card-header title-chapter-container">
            ...
            <div class="title-author-container">
                <h1>{{ Title }}</h1>
                <div class="info-fan">
                    <h3>par <router-link :to="'/getUserBy/' + Author" class="author-text"> {{ Author }}</router-link>
                    </h3>
            ...
            <div class="create-chapter-btn-container">
                <p>
                    <router-link type="button" class="btn btn-primary" v-if="AuthorId === usrCurrent"
                        :to="'/fiction/createChapter/' + IdFiction" v-bind="lastChap">

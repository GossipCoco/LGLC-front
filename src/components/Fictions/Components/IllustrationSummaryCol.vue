<template>
    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-12 col-sm-12 col-xs-12 padding-0-0-0-5vh col-left">
        ...
        <div
            class="display-flex-column border-radius-12px image-fiction-container margin-21vh-0-0-0 all-illustrations-fiction-container padding-2-vh overflowY-X-hidden background-size-cover"
            v-bind:style="{

<template>
  <div
    ...
    class="background-color-main-lineart fiction-globale-container text-white card display-flex-column fiction-container padding-1-rem overflowY-scroll overflowX-hidden opensans-text"
  >

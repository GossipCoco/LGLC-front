<template>
  <div
    ...
    style="width: 25rem; display: flex; flex-direction: row"
    v-for="(character, index) in characters.slice(0, 4)"
    :key="index"
  >
    <div
      class="card-image"
  ...
  <div
    class="character-card card"
    style="width: 25rem; display: flex; flex-direction: column"
    v-for="(character, index) in characters.slice(5, 9)"
    :key="index"
  >
    <div
      class="card-image"

      ...
      <div class="row pagination-zone-container">
        ...
        >
          <div class="row pagination-container">
            <div class="col-5">
              ...
              <ul class="pagination" v-if="navPage.pages >= 12">
                ...
                <div
                  class="pagination"
                  v-if="
                    navPage.current < 3 || navPage.current > navPage.pages - 4
                  "
                >
                  ...
                  <li class="page-item">
                    <button
                      type="button"
                      class="page-link"
                      :disabled="navPage.current == navPage.middle - 2"
                  ...
                  <li class="page-item">
                    <button
                      type="button"
                      class="page-link"
                      :disabled="navPage.current == navPage.middle - 1"
            ...
            <div class="col-3">
              <p>Nombre {{ nbFound }} trouvés {{nBFoundSites}}</p>
            </div>
          </div>
        </div>
      </div>
